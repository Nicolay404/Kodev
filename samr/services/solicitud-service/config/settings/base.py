...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-solicitud')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'solicitud_db'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'apps.solicitud.permissions.JWTAuthentication',
    ],
}

RABBITMQ_URL = os.environ.get('RABBITMQ_URL', 'amqp://guest:guest@rabbitmq:5672/%2F')
SERVICE_NAME = 'solicitud-service'
REDIS_URL = os.environ.get('REDIS_URL', 'redis://redis:6379/0')
MVP_FAQ_CONFIDENCE_THRESHOLD = float(os.environ.get('MVP_FAQ_CONFIDENCE_THRESHOLD', '0.85'))
MVP_CONSORTIUM_OUTCOME = os.environ.get('MVP_CONSORTIUM_OUTCOME', 'validated')
...
CELERY_TASK_DEFAULT_QUEUE = 'solicitud-service.celery'
CELERY_TASK_DEFAULT_EXCHANGE = 'solicitud-service.celery'
CELERY_TASK_DEFAULT_ROUTING_KEY = 'solicitud-service.celery'
CELERY_TIMEZONE = 'UTC'
...
RABBITMQ_QUEUE_SOLICITUD = 'solicitud_service_queue'

RABBITMQ_PUBLISH_KEYS = {
    'solicitud.creada': 'solicitud.creada',
    'solicitud.validada': 'solicitud.validada',
}

RABBITMQ_CONSUME_KEYS = ['vitals.critical_detected']
