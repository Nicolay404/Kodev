...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-historial')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'historial_db'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'apps.historial.permissions.JWTAuthentication',
    ],
}
...
RABBITMQ_QUEUE_HISTORIAL = 'historial_service_queue'
