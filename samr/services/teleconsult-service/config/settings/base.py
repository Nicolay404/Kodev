...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-teleconsult')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'teleconsult_db'),
        'USER': 'samr',
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'apps.teleconsult.permissions.JWTAuthentication',
    ],
}
