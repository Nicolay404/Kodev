...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-default-key-for-cierre')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'cierre_db'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'apps.cierre.permissions.JWTAuthentication',
    ],
}
